...
return this[a]=!0,a}}),n.ajaxPrefilter("json jsonp",function(b,c,d){var e,f,g,h=b.jsonp!==!1&&(Gb.test(b.url)?"url":"string"==typeof b.data&&!(b.contentType||"").indexOf("application/x-www-form-urlencoded")&&Gb.test(b.data)&&"data");return h||"jsonp"===b.dataTypes[0]?(e=b.jsonpCallback=n.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,h?b[h]=b[h].replace(Gb,"$1"+e):b.jsonp!==!1&&(b.url+=(db.test(b.url)?"&":"?")+b.jsonp+"="+e),b.converters["script json"]=function(){return g||n.error(e+" was not called"),g[0]},b.dataTypes[0]="json",f=a[e],a[e]=function(){g=arguments},d.always(function(){a[e]=f,b[e]&&(b.jsonpCallback=c.jsonpCallback,Fb.push(e)),g&&n.isFunction(f)&&f(g[0]),g=f=void 0}),"script"):void 0}),n.parseHTML=function(a,b,c){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(c=b,b=!1),b=b||l;var d=v.exec(a),e=!c&&[];return d?[b.createElement(d[1])]:(d=n.buildFragment([a],b,e),e&&e.length&&n(e).remove(),n.merge([],d.childNodes))};var Hb=n.fn.load;n.fn.load=function(a,b,c){if("string"!=typeof a&&Hb)return Hb.apply(this,arguments);var d,e,f,g=this,h=a.indexOf(" ");return h>=0&&(d=n.trim(a.slice(h)),a=a.slice(0,h)),n.isFunction(b)?(c=b,b=void 0):b&&"object"==typeof b&&(e="POST"),g.length>0&&n.ajax({url:a,type:e,dataType:"html",data:b}).done(function(a){f=arguments,g.html(d?n("<div>").append(n.parseHTML(a)).find(d):a)}).complete(c&&function(a,b){g.each(c,f||[a.responseText,b,a])}),this},n.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(a,b){n.fn[b]=function(a){return this.on(b,a)}}),n.expr.filters.animated=function(a){return n.grep(n.timers,function(b){return a===b.elem}).length};var Ib=a.document.documentElement;n.offset={setOffset:function(a,b,c){var d,e,f,g,h,i,j,k=n.css(a,"position"),l=n(a),m={};"static"===k&&(a.style.position="relative"),h=l.offset(),f=n.css(a,"top"),i=n.css(a,"left"),j=("absolute"===k||"fixed"===k)&&(f+i).indexOf("auto")>-1,j?(d=l.position(),g=d.top,e=d.left):(g=parseFloat(f)||0,e=parseFloat(i)||0),n.isFunction(b)&&(b=b.call(a,c,h)),null!=b.top&&(m.top=b.top-h.top+g),null!=b.left&&(m.left=b.left-h.left+e),"using"in b?b.using.call(a,m):l.css(m)}},n.fn.extend({offset:function(a){if(arguments.length)return void 0===a?this:this.each(function(b){n.offset.setOffset(this,a,b)});var b,c,d=this[0],e={top:0,left:0},f=d&&d.ownerDocument;return f?(b=f.documentElement,n.contains(b,d)?(typeof d.getBoundingClientRect!==U&&(e=d.getBoundingClientRect()),c=Jb(f),{top:e.top+c.pageYOffset-b.clientTop,left:e.left+c.pageXOffset-b.clientLeft}):e):void 0},position:function(){if(this[0]){var a,b,c=this[0],d={top:0,left:0};return"fixed"===n.css(c,"position")?b=c.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),n.nodeName(a[0],"html")||(d=a.offset()),d.top+=n.css(a[0],"borderTopWidth",!0),d.left+=n.css(a[0],"borderLeftWidth",!0)),{top:b.top-d.top-n.css(c,"marginTop",!0),left:b.left-d.left-n.css(c,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||Ib;a&&!n.nodeName(a,"html")&&"static"===n.css(a,"position");)a=a.offsetParent;return a||Ib})}}),n.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(b,c){var d="pageYOffset"===c;n.fn[b]=function(e){return J(this,function(b,e,f){var g=Jb(b);return void 0===f?g?g[c]:b[e]:void(g?g.scrollTo(d?a.pageXOffset:f,d?f:a.pageYOffset):b[e]=f)},b,e,arguments.length,null)}}),n.each(["top","left"],function(a,b){n.cssHooks[b]=ya(k.pixelPosition,function(a,c){return c?(c=xa(a,b),va.test(c)?n(a).position()[b]+"px":c):void 0})}),n.each({Height:"height",Width:"width"},function(a,b){n.each({padding:"inner"+a,content:b,"":"outer"+a},function(c,d){n.fn[d]=function(d,e){var f=arguments.length&&(c||"boolean"!=typeof d),g=c||(d===!0||e===!0?"margin":"border");return J(this,function(b,c,d){var e;return n.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(e=b.documentElement,Math.max(b.body["scroll"+a],e["scroll"+a],b.body["offset"+a],e["offset"+a],e["client"+a])):void 0===d?n.css(b,c,g):n.style(b,c,d,g)},b,f?d:void 0,f,null)}})}),n.fn.size=function(){return this.length},n.fn.andSelf=n.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return n});var Kb=a.jQuery,Lb=a.$;return n.noConflict=function(b){return a.$===n&&(a.$=Lb),b&&a.jQuery===n&&(a.jQuery=Kb),n},typeof b===U&&(a.jQuery=a.$=n),n});var util={makeId:function(){for(var text="",possible="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",i=0;5>i;i++)text+=possible.charAt(Math.floor(Math.random()*possible.length));return text}},app=angular.module("cardsAgainstHumanity",["ui.router"]);app.config(function($stateProvider,$urlRouterProvider,$locationProvider){$urlRouterProvider.otherwise("/"),$stateProvider.state("index",{url:"/",templateUrl:"html/pages/index.html",controller:"indexCtrl",data:{title:""}}).state("lobby",{url:"/:sessionId/lobby",templateUrl:"html/pages/lobby.html",controller:"lobbyCtrl",data:{title:"Lobby"}}).state("hosting",{url:"/:sessionId/hosting",templateUrl:"html/pages/hosting.html",controller:"hostingCtrl",data:{title:"Hosting Game"}}).state("playing",{url:"/:sessionId/playing",templateUrl:"html/pages/playing.html",controller:"playingCtrl",data:{title:"Playing Game"}})}),app.config(["$httpProvider",function($httpProvider){$httpProvider.defaults.headers.post["Content-Type"]="application/x-www-form-urlencoded;charset=utf-8";var param=function(obj){var name,value,fullSubName,subName,subValue,innerObj,i,query="";for(name in obj)if(value=obj[name],value instanceof Array)for(i=0;i<value.length;++i)subValue=value[i],fullSubName=name+"["+i+"]",innerObj={},innerObj[fullSubName]=subValue,query+=param(innerObj)+"&";else if(value instanceof Object)for(subName in value)subValue=value[subName],fullSubName=name+"["+subName+"]",innerObj={},innerObj[fullSubName]=subValue,query+=param(innerObj)+"&";else void 0!==value&&null!==value&&(query+=encodeURIComponent(name)+"="+encodeURIComponent(value)+"&");return query.length?query.substr(0,query.length-1):query};$httpProvider.defaults.transformRequest=[function(data){return angular.isObject(data)&&"[object File]"!==String(data)?param(data):data}]}]),app.filter("trust",["$sce",function($sce){return function(value,type){return $sce.trustAs(type||"html",value)}}]);var Game=function(data){data=JSON.parse(data);var self=this;$.each(data,function(key,val){self[key]=val}),this.log=this.log.map(function(value){var time=new Date(1e3*value.time),hours=time.getHours(),a="AM";hours>12&&(hours-=12,a="PM");var minutes=time.getMinutes()<10?"0"+time.getMinutes():time.getMinutes();return value.time=hours+":"+minutes+a,value.user=self.findUserById(value.from).name,value})};Game.prototype.amHost=function(){return localStorage.userId===this.host},Game.prototype.findUserById=function(id){return"system"===id?{name:"Host"}:this.players.filter(function(value){return value.id===id})[0]},Game.prototype.getCzar=function(){var filtered=this.players.filter(function(value){return!!value.isCzar});return filtered.length?filtered[0]:null},app.service("api",["$http","$rootScope",function($http,$root){function _put(uri,payload,params){return $http.put(base+uri+".php",payload,{params:params})}function _get(uri,params){return $http.get(base+uri+".php",{params:params})}function _post(uri,payload){return $http.post(base+uri+".php",payload)}var base="http://games.wattydev.com/cardsAgainstHumanity/api";return{update:function(){return _put("/update",$session.model,{})},createGame:function(name){return _get("/newGame",{host:$root.userId,nickname:name||util.makeId()})},joinGame:function(id,username,userid){return _get("/joinGame",{id:id,username:username,userid:userid})},sendMessage:function(data){return _post("/sendMessage",data)},startGame:function(id){return _post("/startGame",{id:id})},nextRound:function(gameId,czarId){var data={gameId:gameId};return czarId&&(data.czarId=czarId),_post("/nextRound",data)}}}]),app.service("gameService",["sse","api","$q","$rootScope",function($sse,$api,$q,$root){var service={data:{},games:{},newGame:function(name){var self=this;return $q(function(resolve,reject){var id;$api.createGame(name).then(function(response){id=response.data,self.connect(id),resolve(id)})})},joinGame:function(id,username,userid){var self=this;return $q(function(resolve,reject){$api.joinGame(id,username,userid).then(function(response){self.connect(id),resolve()})})},sendMessage:function(message){var self=this;$api.sendMessage({gameId:self.data.id,userId:localStorage.userId,message:message})},connect:function(id){this.data.id||$sse.openStream(id)},startGame:function(id){$api.startGame(id)}};return $root.$on("gameUpdate",function(event,message){service.data=new Game(message.data)}),$root.$on("statusUpdate",function(event,message){service.games=JSON.parse(message.data).games}),service}]),app.service("sse",["$rootScope",function($root){function listen(e){$root.$broadcast(e.type,e)}function init(){var functions=[function(){var data=new EventSource("http://games.wattydev.com/cardsAgainstHumanity/api/events.php");data.addEventListener("statusUpdate",listen)}];functions.forEach(function(fn){fn()})}return init(),{openStream:function(id){var data=new EventSource("http://games.wattydev.com/cardsAgainstHumanity/api/events.php?id="+id);data.addEventListener("gameUpdate",listen)}}}]),app.controller("hostingCtrl",["$scope","$rootScope","gameService","$state","api",function($scope,$root,$game,$state,$api){function getData(){$scope.game=$game.data,$scope.$apply()}function init(){var functions=[function(){$game.connect($state.params.sessionId)}];functions.forEach(function(fn){fn()})}$scope.game=$game.data,$scope.vars={lastPooped:null},$scope.nextRound=function(id){$api.nextRound($scope.game.id,id)},init(),$root.$on("gameUpdate",getData)}]),app.controller("indexCtrl",["$scope","$rootScope","$state","gameService",function($scope,$root,$state,$game){$scope.games=$game.games,$scope.startingGame=!1,$scope.newGame=function(){if($scope.startingGame){util.makeId();$game.newGame($scope.gameName).then(function(id){$state.go("lobby",{sessionId:id})})}else $scope.startingGame=!0},$scope.joinGame=function(id){$scope.joiningGame?$game.joinGame(id,$scope.userName,localStorage.userId).then(function(){$state.go("lobby",{sessionId:id})}):$scope.joiningGame=id},$scope.invalidId=function(){return!($scope.joinId&&5===$scope.joinId.length)},$root.$on("statusUpdate",function(){$scope.games=$game.games,$scope.$apply()})}]),app.controller("lobbyCtrl",["$scope","$state","gameService","$rootScope",function($scope,$state,$game,$root){function getData(){$scope.game=$game.data,$scope.$apply(),$scope.game.started&&$state.go("playing",{sessionId:$scope.game.id})}function init(){var functions=[function(){$game.connect($state.params.sessionId)}];functions.forEach(function(fn){fn()})}$scope.game=$game.data,$scope.sendMessage=function(message){$game.sendMessage(message),$scope.chatMessage=""},$scope.startGame=function(){var id=$scope.game.id;$game.startGame(id),$state.go("hosting",{sessionId:id})},init(),$root.$on("gameUpdate",getData)}]),app.controller("mainCtrl",["$scope","$rootScope","$state",function($scope,$root,$state){$scope.state=$state,$root.userId=localStorage.userId||util.makeId(),localStorage.userId=$root.userId}]),app.controller("playingCtrl",["$scope","$rootScope","gameService","$state",function($scope,$root,$game,$state){function getData(){$scope.game=$game.data,$game&&($scope.me=$scope.game.findUserById(localStorage.userId)),$scope.$apply()}function init(){var functions=[function(){$game.connect($state.params.sessionId)}];functions.forEach(function(fn){fn()})}$scope.game=$game.data,$scope.vars={viewing:null,selected:[],numToSelect:1},$scope.sendMessage=function(message){$game.sendMessage(message),$scope.chatMessage=""},$scope.viewCard=function(id){$scope.vars.viewing===id?$scope.vars.viewing=null:$scope.vars.viewing=id},$scope.selectViewedCard=function(){var viewedIndex,viewed=$scope.me.hand.filter(function(card,index){return card.id===$scope.vars.viewing?(viewedIndex=index,!0):!1});$scope.vars.push(viewed[0]),$scope.me.hand.splice(viewedIndex,1),$scope.vars.viewing=null},$scope.cancelSelection=function(card){var selectedIndex,selected=$scope.vars.selected.filter(function(_card,index){return card.id===_card.id?(selectedIndex=index,!0):!1});$scope.me.hand.push(selected[0]),$scope.vars.selected.splice(selectedIndex,1)},$scope.sendCards=function(){},init(),$root.$on("gameUpdate",getData)}]),app.directive("card",function(){function link($scope,$elem,$attrs){$scope.$watch("card",function(){$scope.card&&($scope.text=$scope.card.text.replace(" - ",'<span class="blank"></span>'))},!0)}return{restrict:"E",link:link,templateUrl:"/html/directives/card.html",scope:{card:"=card"}}}),app.directive("fillRemainingSpace",function(){function link($scope,$elem,$attrs){$elem=$($elem);var parentHeight=$elem.parents().height(),parentOffset=$elem.parents().offset().top,elemOffset=$elem.offset().top,difference=elemOffset-parentOffset,height=parentHeight-difference;$elem.css("height",height+"px")}return{restrict:"A",link:link}});