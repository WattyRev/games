...
return this[a]=!0,a}}),n.ajaxPrefilter("json jsonp",function(b,c,d){var e,f,g,h=b.jsonp!==!1&&(Gb.test(b.url)?"url":"string"==typeof b.data&&!(b.contentType||"").indexOf("application/x-www-form-urlencoded")&&Gb.test(b.data)&&"data");return h||"jsonp"===b.dataTypes[0]?(e=b.jsonpCallback=n.isFunction(b.jsonpCallback)?b.jsonpCallback():b.jsonpCallback,h?b[h]=b[h].replace(Gb,"$1"+e):b.jsonp!==!1&&(b.url+=(db.test(b.url)?"&":"?")+b.jsonp+"="+e),b.converters["script json"]=function(){return g||n.error(e+" was not called"),g[0]},b.dataTypes[0]="json",f=a[e],a[e]=function(){g=arguments},d.always(function(){a[e]=f,b[e]&&(b.jsonpCallback=c.jsonpCallback,Fb.push(e)),g&&n.isFunction(f)&&f(g[0]),g=f=void 0}),"script"):void 0}),n.parseHTML=function(a,b,c){if(!a||"string"!=typeof a)return null;"boolean"==typeof b&&(c=b,b=!1),b=b||l;var d=v.exec(a),e=!c&&[];return d?[b.createElement(d[1])]:(d=n.buildFragment([a],b,e),e&&e.length&&n(e).remove(),n.merge([],d.childNodes))};var Hb=n.fn.load;n.fn.load=function(a,b,c){if("string"!=typeof a&&Hb)return Hb.apply(this,arguments);var d,e,f,g=this,h=a.indexOf(" ");return h>=0&&(d=n.trim(a.slice(h)),a=a.slice(0,h)),n.isFunction(b)?(c=b,b=void 0):b&&"object"==typeof b&&(e="POST"),g.length>0&&n.ajax({url:a,type:e,dataType:"html",data:b}).done(function(a){f=arguments,g.html(d?n("<div>").append(n.parseHTML(a)).find(d):a)}).complete(c&&function(a,b){g.each(c,f||[a.responseText,b,a])}),this},n.each(["ajaxStart","ajaxStop","ajaxComplete","ajaxError","ajaxSuccess","ajaxSend"],function(a,b){n.fn[b]=function(a){return this.on(b,a)}}),n.expr.filters.animated=function(a){return n.grep(n.timers,function(b){return a===b.elem}).length};var Ib=a.document.documentElement;n.offset={setOffset:function(a,b,c){var d,e,f,g,h,i,j,k=n.css(a,"position"),l=n(a),m={};"static"===k&&(a.style.position="relative"),h=l.offset(),f=n.css(a,"top"),i=n.css(a,"left"),j=("absolute"===k||"fixed"===k)&&(f+i).indexOf("auto")>-1,j?(d=l.position(),g=d.top,e=d.left):(g=parseFloat(f)||0,e=parseFloat(i)||0),n.isFunction(b)&&(b=b.call(a,c,h)),null!=b.top&&(m.top=b.top-h.top+g),null!=b.left&&(m.left=b.left-h.left+e),"using"in b?b.using.call(a,m):l.css(m)}},n.fn.extend({offset:function(a){if(arguments.length)return void 0===a?this:this.each(function(b){n.offset.setOffset(this,a,b)});var b,c,d=this[0],e={top:0,left:0},f=d&&d.ownerDocument;return f?(b=f.documentElement,n.contains(b,d)?(typeof d.getBoundingClientRect!==U&&(e=d.getBoundingClientRect()),c=Jb(f),{top:e.top+c.pageYOffset-b.clientTop,left:e.left+c.pageXOffset-b.clientLeft}):e):void 0},position:function(){if(this[0]){var a,b,c=this[0],d={top:0,left:0};return"fixed"===n.css(c,"position")?b=c.getBoundingClientRect():(a=this.offsetParent(),b=this.offset(),n.nodeName(a[0],"html")||(d=a.offset()),d.top+=n.css(a[0],"borderTopWidth",!0),d.left+=n.css(a[0],"borderLeftWidth",!0)),{top:b.top-d.top-n.css(c,"marginTop",!0),left:b.left-d.left-n.css(c,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var a=this.offsetParent||Ib;a&&!n.nodeName(a,"html")&&"static"===n.css(a,"position");)a=a.offsetParent;return a||Ib})}}),n.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(b,c){var d="pageYOffset"===c;n.fn[b]=function(e){return J(this,function(b,e,f){var g=Jb(b);return void 0===f?g?g[c]:b[e]:void(g?g.scrollTo(d?a.pageXOffset:f,d?f:a.pageYOffset):b[e]=f)},b,e,arguments.length,null)}}),n.each(["top","left"],function(a,b){n.cssHooks[b]=ya(k.pixelPosition,function(a,c){return c?(c=xa(a,b),va.test(c)?n(a).position()[b]+"px":c):void 0})}),n.each({Height:"height",Width:"width"},function(a,b){n.each({padding:"inner"+a,content:b,"":"outer"+a},function(c,d){n.fn[d]=function(d,e){var f=arguments.length&&(c||"boolean"!=typeof d),g=c||(d===!0||e===!0?"margin":"border");return J(this,function(b,c,d){var e;return n.isWindow(b)?b.document.documentElement["client"+a]:9===b.nodeType?(e=b.documentElement,Math.max(b.body["scroll"+a],e["scroll"+a],b.body["offset"+a],e["offset"+a],e["client"+a])):void 0===d?n.css(b,c,g):n.style(b,c,d,g)},b,f?d:void 0,f,null)}})}),n.fn.size=function(){return this.length},n.fn.andSelf=n.fn.addBack,"function"==typeof define&&define.amd&&define("jquery",[],function(){return n});var Kb=a.jQuery,Lb=a.$;return n.noConflict=function(b){return a.$===n&&(a.$=Lb),b&&a.jQuery===n&&(a.jQuery=Kb),n},typeof b===U&&(a.jQuery=a.$=n),n}),angular.module("angular-parallax",[]).directive("parallax",["$window",function($window){return{restrict:"A",scope:{parallaxRatio:"@"},link:function($scope,elem,attrs){var setPosition=function(){var isiOS=/iPhone|iPad|iPod/i.test(navigator.userAgent);if(!($(window).width<400||isiOS)){var screenTop=$(window).scrollTop(),containerTop=$(elem).parent().offset().top,topVal=($(elem).height(),$(window).height(),(screenTop-containerTop)*($scope.parallaxRatio?$scope.parallaxRatio:1.1));elem.css("transform","translate(0, "+topVal+"px)")}};setPosition(),$scope.$watch(function(){return $(document).height()},function(newValue,oldValue){setPosition()}),angular.element($window).bind("scroll",setPosition),angular.element($window).bind("touchmove",setPosition)}}}]);var app=angular.module("wedding",["ui.router","angular-parallax"]);app.config(function($stateProvider,$urlRouterProvider,$locationProvider){$urlRouterProvider.otherwise("/people"),-1===window.location.hostname.indexOf("localhost")&&$locationProvider.html5Mode({enabled:!0,requireBase:!1}),$stateProvider.state("rsvp",{url:"/rsvp",templateUrl:"html/pages/rsvp.html",controller:"rsvpCtrl",data:{title:"RSVP"}}).state("schedule",{url:"/schedule",templateUrl:"html/pages/schedule.html",controller:"scheduleCtrl",data:{title:"Schedule"}}).state("registry",{url:"/registry",templateUrl:"html/pages/registry.html",controller:"registryCtrl",data:{title:"Registry"}}).state("people",{url:"/people",templateUrl:"html/pages/people.html",controller:"peopleCtrl",data:{title:"People"}}).state("admin",{url:"/admin",templateUrl:"html/pages/admin.html",controller:"adminCtrl",data:{title:"Manage Guests"}}).state("add-guest",{url:"/add-guest",templateUrl:"html/pages/add-guest.html",controller:"addGuestCtrl",data:{title:"Add Guest"}}).state("edit-guest",{url:"/edit-guest/:id",templateUrl:"html/pages/edit-guest.html",controller:"editGuestCtrl",data:{title:"Edit Guest"}}).state("comments",{url:"/comments",templateUrl:"html/pages/comments.html",controller:"commentsCtrl",data:{title:"Manage Comments"}})}),app.controller("addGuestCtrl",["$scope","$rootScope","$state","api",function($scope,$root,$state,$api){function init(){var functions=[$scope.authorize];functions.forEach(function(fn){fn()})}$scope.authorized=!1,$scope.meta={password:"",loading:!1},$scope.errors={auth:!1,save:!1},$scope.guest={first_name:"",last_name:"",email:"",address:"",city:"",state:"",postal_code:"",allowedPlus:!1},$scope.authorize=function(){$scope.errors.auth=!1,$scope.meta.password&&($root.admin=$scope.meta.password),$scope.meta.loading=!0,$api.admin.auth($root.admin).then(function(){$scope.authorized=!0,$scope.meta.loading=!1},function(){$scope.errors.auth=!0,$scope.meta.loading=!1})},$scope.addGuest=function(){$scope.meta.loading||($scope.meta.loading=!0,$api.guest.add($scope.guest,$root.admin).then(function(response){$scope.meta.loading=!1,$scope.meta.addMore?($scope.guest.first_name="",$scope.guest.last_name="",$scope.guest.email="",$scope.guest.address="",$scope.guest.city="",$scope.guest.state="",$scope.guest.postal_code="",$scope.guest.allowedPlus=!1):$state.go("admin")},function(){$scope.meta.loading=!1,$scope.errors.save=!0}))},init()}]),app.controller("adminCtrl",["$scope","$rootScope","api","$timeout","$state",function($scope,$root,$api,$timeout,$state){function init(){var functions=[$scope.authorize];functions.forEach(function(fn){fn()})}$scope.authorized=!1,$scope.meta={password:"",loading:!1,total:0,totalMax:0,totalConfirmed:0,totalMaybe:0,totalNo:0,totalUnresponsive:0,filter:"",sort:"name",sortDirection:"ascending"},$scope.errors={auth:!1,get:!1,"delete":!1},$scope.guestsRaw=[],$scope.guests=[],$scope.authorize=function(){$scope.errors.auth=!1,$scope.meta.password&&($root.admin=$scope.meta.password),$scope.meta.loading=!0,$api.admin.auth($root.admin).then(function(){$scope.authorized=!0,$scope.getGuests()},function(){$scope.errors.auth=!0,$scope.meta.loading=!1})},$scope.getGuests=function(){$scope.meta.total=0,$scope.meta.totalMax=0,$scope.meta.totalConfirmed=0,$scope.meta.totalNo=0,$scope.meta.totalUnresponsive=0,$scope.meta.totalMaybe=0,$scope.meta.totalConfirmedPlus=0,$scope.errors.get=!1,$scope.meta.loading=!0,$api.guests.getAll($root.admin).then(function(response){$scope.meta.loading=!1,$scope.guestsRaw=response.data,$scope.guestsRaw.map(function(guest){return guest.max_plusses=parseInt(guest.max_plusses),guest.plusses=parseInt(guest.plusses),guest.rsvp_date&&(guest.rsvp_date=$scope.convertSqlTime(guest.rsvp_date).getTime()),guest.plus_names||(guest.plus_names="[]"),guest.plus_names=JSON.parse(guest.plus_names),$scope.meta.total++,$scope.meta.totalMax++,guest.max_plusses&&$scope.meta.totalMax++,"Yes"===guest.status?($scope.meta.totalConfirmed++,guest.plusses&&$scope.meta.totalConfirmedPlus++):"Maybe"===guest.status?$scope.meta.totalMaybe++:"No"===guest.status?$scope.meta.totalNo++:$scope.meta.totalUnresponsive++,guest}),$scope.filter()},function(){$scope.meta.loading=!1,$scope.errors.get=!0})},$scope.sort=function(metric){var meta=$scope.meta;metric&&(meta.sort===metric&&"ascending"===meta.sortDirection?meta.sortDirection="descending":meta.sortDirection="ascending",meta.sort=metric),$scope.guests.sort(function(a,b){a.name=a.first_name+" "+a.last_name,b.name=b.first_name+" "+b.last_name;var direction=1;return"descending"===meta.sortDirection&&(direction=-1),a[meta.sort]>b[meta.sort]?-1*direction:a[meta.sort]<b[meta.sort]?1*direction:a.name>b.name?-1*direction:a.name<b.name?1*direction:0})},$scope.filter=function(){var filter=$scope.meta.filter.toLowerCase();filter?$scope.guests=$scope.guests.filter(function(guest){var name=(guest.first_name+" "+guest.last_name).toLowerCase(),email=guest.email.toLowerCase();return name.indexOf(filter)>-1||email.indexOf(filter)>-1}):$scope.guests=$scope.guestsRaw,$scope.sort()},$scope.deleteGuest=function(guest){$scope.errors["delete"]=!1,guest.confirmDelete?($scope.meta.loading=!0,$api.guest["delete"](guest.id,$root.admin).then(function(){$scope.getGuests()},function(){$scope.meta.loading=!1,$scope.errors["delete"]=!0})):(guest.confirmDelete=!0,$timeout(function(){guest.confirmDelete=!1},2e3))},$scope.editGuest=function(guest){$state.go("edit-guest",{id:guest.id})},$scope.convertSqlTime=function(sqlTime){var t=sqlTime.split(/[- :]/);return new Date(t[0],t[1]-1,t[2],t[3],t[4],t[5])},$scope.showNote=function(note){$scope.meta.note=note,$("body").css("overflow","hidden"),$(".viewNote").fadeIn()},$scope.closeNote=function(){$("body").css("overflow",""),$(".viewNote").fadeOut()},init(),$scope.$watch("meta.filter",$scope.filter),$scope.$watch("meta.sort",$scope.sort)}]),app.controller("commentsCtrl",["$scope","$rootScope","api","$timeout",function($scope,$root,$api,$timeout){function init(){var functions=[$scope.authorize];functions.forEach(function(fn){fn()})}$scope.authorized=!1,$scope.meta={password:"",loading:!1,total:0,totalApproved:0},$scope.errors={auth:!1,get:!1,"delete":!1,approve:!1},$scope.comments=[],$scope.authorize=function(){$scope.errors.auth=!1,$scope.meta.password&&($root.admin=$scope.meta.password),$scope.meta.loading=!0,$api.admin.auth($root.admin).then(function(){$scope.authorized=!0,$scope.getComments()},function(){$scope.errors.auth=!0,$scope.meta.loading=!1})},$scope.getComments=function(){$scope.meta.total=0,$scope.meta.totalApproved=0,$scope.errors.get=!1,$scope.meta.loading=!0,$api.comments.get().then(function(response){$scope.meta.loading=!1,$scope.comments=response.data,$scope.comments.map(function(comment){return comment.approved=parseInt(comment.approved),comment.date=$scope.convertSqlTime(comment.date).getTime(),$scope.meta.total++,comment.approved&&$scope.meta.totalApproved++,comment})},function(){$scope.meta.loading=!1,$scope.errors.get=!0})},$scope.deleteComment=function(comment){$scope.errors["delete"]=!1,comment.confirmDelete?($scope.meta.loading=!0,$api.comment["delete"](comment.id,$root.admin).then(function(){$scope.getComments()},function(){$scope.meta.loading=!1,$scope.errors["delete"]=!0})):(comment.confirmDelete=!0,$timeout(function(){comment.confirmDelete=!1},2e3))},$scope.approveComment=function(comment){$scope.meta.loading=!0;var approve=comment.approved?0:1;$api.comment.approve(comment.id,approve).then(function(){$scope.getComments()},function(){$scope.meta.loading=!1,$scope.error.approve=!0})},$scope.convertSqlTime=function(sqlTime){var t=sqlTime.split(/[- :]/);return new Date(t[0],t[1]-1,t[2],t[3],t[4],t[5])},init()}]),app.controller("editGuestCtrl",["$scope","$rootScope","$state","api",function($scope,$root,$state,$api){function init(){var functions=[$scope.authorize];functions.forEach(function(fn){fn()})}$scope.authorized=!1,$scope.meta={password:"",loading:!1},$scope.errors={auth:!1,save:!1},$scope.authorize=function(){$scope.errors.auth=!1,$scope.meta.password&&($root.admin=$scope.meta.password),$scope.meta.loading=!0,$api.admin.auth($root.admin).then(function(){$scope.authorized=!0,$scope.meta.loading=!1,$scope.getGuest()},function(){$scope.errors.auth=!0,$scope.meta.loading=!1})},$scope.getGuest=function(){$scope.meta.loading=!0,$api.guest.get($state.params.id).then(function(response){$scope.meta.loading=!1,response.data.id=parseInt(response.data.id),response.data.max_plusses=parseInt(response.data.max_plusses),$scope.guest=response.data,$scope.guest.allowedPlus=1===$scope.guest.max_plusses},function(){$scope.errors.getGuest=!0,$scope.meta.loading=!1})},$scope.saveGuest=function(){$scope.meta.loading||($scope.meta.loading=!0,$api.guest.update($scope.guest,$root.admin).then(function(response){$scope.meta.loading=!1,$state.go("admin")},function(){$scope.loading=!1,$scope.errors.save=!0}))},init()}]),app.controller("mainCtrl",["$scope","$rootScope","$state",function($scope,$root,$state){$scope.state=$state,$root.showContact=function(){$("html").css("overflow","hidden"),$("contact").fadeIn()},$root.hideContact=function(){$("html").css("overflow",""),$("contact").fadeOut()}}]),app.controller("peopleCtrl",["$scope","$rootScope","$http",function($scope,$root,$http){}]),app.controller("registryCtrl",["$scope","$rootScope","$http",function($scope,$root,$http){}]),app.controller("rsvpCtrl",["$scope","$rootScope","api","$timeout","$q",function($scope,$root,$api,$timeout,$q){$scope.guests=[],$scope.meta={loadingGuest:!1,lookupTimer:null,scrollTimer:null,sendingRsvp:!1,sent:!1,code:""},$scope.errors={status:!1,send:!1},$scope.findInvitation=function(){return $scope.meta.loadingGuest=!0,$scope.meta.searchedGuest=!0,$scope.meta.lookupTimer&&$timeout.cancel($scope.meta.lookupTimer),$scope.meta.code?void($scope.meta.lookupTimer=$timeout(function(){$api.guest.find($scope.meta.code.toLowerCase()).then(function(response){$scope.meta.code="";var guest={};$scope.meta.loadingGuest=!1,$scope.meta.foundGuest=!0,guest=response.data,guest.name=guest.first_name+" "+guest.last_name,guest.max_plusses=parseInt(guest.max_plusses),guest.plusses=parseInt(guest.plusses),guest.plus_one=guest.plusses?!0:!1,guest.code=guest.code,guest.plus_names||(guest.plus_names="[]"),guest.plus_names=JSON.parse(guest.plus_names),$scope.guests.push(guest),$timeout(function(){$scope.scrollToGuest($scope.guests.length)},10)},function(response){$scope.meta.loadingGuest=!1})},300)):($scope.meta.loadingGuest=!1,void($scope.meta.searchedGuest=!1))},$scope.sendRsvp=function(){if($scope.errors.send=!1,$scope.guests.length&&!$scope.meta.loadingGuest){if($scope.guests.map(function(guest){return guest.plusses=guest.plus_one?1:0,guest.status||($scope.errors.status=!0),guest}),$scope.errors.status)return void $scope.scrollToForm();$scope.meta.sendingRsvp=!0;var promises=[];$scope.guests.forEach(function(guest){promises.push($api.guest.rsvp(guest))}),$q.all(promises).then(function(responses){$scope.meta.sendingRsvp=!1;var failures=(responses.length,[]);if(response.forEach(function(response,index){200!==response.status&&failures.push(index)}),failures.length){var _guests=[];failures.forEach(function(index){_guests.push($scope.guests[index])}),$scope.guests=_guests,$scope.errors.send=!0}else $scope.guests=[],$scope.meta.sent=!0})}},$scope.scrollToForm=function(){var top=$("#content").offset().top;$("body").animate({scrollTop:top+"px"},300)},$scope.scrollToGuest=function(num){$scope.meta.scrollTimer&&$timeout.cancel($scope.meta.scrollTimer);var guest=$(".guest:nth-child("+num+") .heading");guest.click(),$timeout(function(){var top=$(".guest:nth-child("+num+")").offset().top-50;$("body").animate({scrollTop:top+"px"},300)},500)},$scope.removeGuest=function(index){$scope.guests.splice(index,1)}}]),app.controller("scheduleCtrl",["$scope","$rootScope","$http",function($scope,$root,$http){}]),app.directive("accordion",function(){function link($scope,$elem,$attrs){$elem=$($elem),$elem.click(function(e){var elem,target=$(e.target);!target.hasClass("heading")&&!target.parents(".heading").length||target.hasClass("fa-close")||(elem=target.parents(".guest"),elem.hasClass("open")?elem.removeClass("open"):($elem.find(".open").removeClass("open"),elem.addClass("open")))}),$elem.find(".heading").click(function(){$(this)})}return{restrict:"AE",link:link}}),app.directive("adminNav",function(){function link($scope,$elem,$attrs){}return{restrict:"E",link:link,templateUrl:"html/directives/admin-nav.html",scope:{current:"@"}}}),app.directive("alignVertical",function(){function link($scope,$elem,$attrs){function evaluate(){var contentSize=$elem.height(),containerSize=$elem.parent().height(),margin=(containerSize-contentSize)/2;$elem.css("margin-top",margin+"px")}$elem=$($elem),evaluate(),$(window).resize(evaluate)}return{restrict:"A",link:link,scope:"="}}),app.directive("animateOnShow",function(){function link($scope,$elem,$attrs){function onScroll(){var animPoint=$elem.offset().top,position=$(window).scrollTop()+$(window).height()/2;position>=animPoint&&!$elem.hasClass("show")?$elem.addClass("show"):animPoint>position&&$elem.hasClass("show")&&$elem.removeClass("show")}$elem=$($elem),$(window).scroll(onScroll)}return{restrict:"A",link:link,scope:"="}}),app.directive("checkbox",function(){function link($scope,$elem,$attrs){$elem=$($elem),$elem.wrap('<label class="checkbox"></label>'),$elem.after('<i class="fa fa-check"></i>')}return{restrict:"A",link:link}}),app.directive("comments",["api",function($api){function link($scope,$elem,$attr){function init(){var functions=[$scope.getComments];functions.forEach(function(fn){fn()})}$scope.comments=[],$scope.meta={loading:!1},$scope.errors={comment:!1,comments:!1},$scope.comment={name:"",email:"",message:""},$scope.addComment=function(){$scope.meta.loading=!0,$api.comment.add($scope.comment).then(function(response){$scope.meta.loading=!1,$scope.meta.commentSent=!0;var message="The following comment has been submitted to wedding.wattydev.com by "+$scope.comment.name+" ("+$scope.comment.email+"):\r\n\r\n "+$scope.comment.message+"\r\n\r\n Approve: http://weddingapi.wattydev.com/comments/approve/index.php?id="+response.data+"&approve=1";$api.email.send({name:$scope.comment.name,from:$scope.comment.email,message:message,subject:"New comment submitted"})},function(){$scope.meta.loading=!1,$scope.errors.comment=!0})},$scope.getComments=function(){$scope.meta.loading=!0,$api.comments.get().then(function(response){$scope.meta.loading=!1,$scope.comments=response.data,$scope.comments=$scope.comments.filter(function(value){return"0"!==value.approved})},function(){$scope.meta.loading=!1,$scope.errors.comments=!0})},init()}return{restrict:"E",link:link,templateUrl:"html/directives/comments.html"}}]),app.directive("contact",["api",function($api){function link($scope,$elem,$attr){$scope.message={from:"",name:"",subject:"",message:""},$scope.meta={sending:!1,sent:!1},$scope.errors={send:!1},$scope.sendMessage=function(){$scope.meta.sending||($scope.meta.sending=!0,$api.email.send($scope.message).then(function(){$scope.meta.sending=!1,$scope.meta.sent=!0},function(){$scope.errors.send=!0,$scope.meta.sending=!1}))}}return{restrict:"E",link:link,templateUrl:"html/directives/contact.html"}}]),app.directive("header",function(){function link($scope,$elem,$attrs){}return{restrict:"E",link:link,templateUrl:"html/directives/header.html"}}),app.controller("mainCtrl",["$scope","$rootScope","$state",function($scope,$root,$state){$scope.state=$state,$root.showContact=function(){$("html").css("overflow","hidden"),$("contact").fadeIn()},$root.hideContact=function(){$("html").css("overflow",""),$("contact").fadeOut()}}]),app.directive("toggle",function(){function link($scope,$elem,$attrs){$elem=$($elem),$elem.wrap('<label class="toggle"></label>'),$elem.after('<span class="background"></span><span class="handle"></span>')}return{restrict:"A",link:link}}),app.service("api",["$http",function($http){function _get(uri,params){return $http.get(base+uri+"/index.php",{params:params})}function _put(uri,payload,params){return $http.put(base+uri+"/index.php",payload,{params:params})}function _delete(uri,params){return $http["delete"](base+uri+"/index.php",{params:params})}var base="http://weddingapi.wattydev.com";return{admin:{auth:function(pass){return _get("/admin/auth",{pass:pass})}},comment:{add:function(comment){return _put("/comments",null,comment)},"delete":function(id,pass){return _delete("/comments",{id:id,pass:pass})},approve:function(id,approve){return _put("/comments/approve",null,{id:id,approve:approve})}},comments:{get:function(){return _get("/comments",{})}},guest:{find:function(code){return _get("/guests",{code:code})},get:function(id){return _get("/guests",{id:id})},rsvp:function(guest){return guest.plus_names=JSON.stringify(guest.plus_names),guest.plusses?guest.plusses=1:guest.plusses=0,_put("/guests/rsvp",null,guest)},add:function(guest,pass){return guest.allowedPlus?guest.max_plusses=1:guest.max_plusses=0,guest.pass=pass,_put("/guests",null,guest)},update:function(guest,pass){return guest.allowedPlus?guest.max_plusses=1:guest.max_plusses=0,guest.pass=pass,_put("/guests",null,guest)},"delete":function(id,pass){return _delete("/guests",{id:id,pass:pass})}},guests:{getAll:function(pass){return _get("/guests",{pass:pass})}},email:{send:function(params){return _put("/email",null,{name:params.name,from:params.from,message:params.message,to:"ellewatsonwedding@gmail.com",subject:"From wedding website: "+params.subject})}}}}]);